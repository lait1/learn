            ...
            <div class="container">
                ...
                <div class="top-header__login dropdown pull-right login">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/learn/admin">Личный кабинет</a></li>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/learn">Главная</a></li>
                        <li><a href="/learn/news">Новости</a></li>
                        <li><a href="/learn/events">Расписание</a></li> 
                        <li><a href="/learn/comments">Отзывы</a></li> 
                        <li><a href="/learn/contact">Контакты</a></li> 
                    </ul>
                </div>
            </div>
        </div>